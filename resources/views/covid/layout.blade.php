...
<body>
        ...
        <header class="header">
            <div class="container">
                ...
                <nav class="py-3">
                	<div id="logo">
                        <h1> <a class="navbar-brand" href="/cxj/"><img style="width: 8em;" src="{{ asset('img/cxj/logo_techo.png') }}" alt="TECHO"></a>
                             <a class="navbar-brand" target="_blank" href="https://www.techo.org/" style="float:right;"> 
                              <img style="width: 8em; "  src="{{ asset('img/cxj/covid.png') }}" alt="user-image">
                            </a>
                        </h1>
                    </div>
