...
@section('content')
            ...
            <div class="container">
                <div class="row banner-grids">
                    <div class="col-lg-6 banner-info-w3ls">
                        <h2>Vivi en tu Ciudad
                        </h2>
                        <h3 class="mb-3">Ciudades x Jovenes</h3>
                        <p class="mb-4"> Un movimiento para que jóvenes de toda América Latina, propongamos las ciudades que queremos y demostremos nuestro compromiso para lograrlo.
</p>
                        <a href="about.html" class="btn">Sumate</a>
                    </div>
                    ...
                    <div class="row fetured-sec mt-lg-5 mt-3">
                        <div class="col-lg-6 p-0">
                            <div class="img-effect">
                                <img src="{{ asset('img/cxj/img1.jpg') }}" alt="" class="img-fluid image1">
                            </div>
                ...
                <div class="row mt-lg-5 mt-4">
                    <div class="col-md-4 team-gd text-center">
                        <div class="team-img mb-4">
                            <img src="{{ asset('img/cxj/team.jpg') }}" class="img-fluid" alt="user-image">
                        </div>
                        <div class="team-info">
                    ...
                    <div class="col-md-4 team-gd second text-center">
                        <div class="team-img mb-4">
                            <img src="{{ asset('img/cxj/team1.jpg') }}" class="img-fluid" alt="user-image">
                        </div>
                        <div class="team-info">
                    ...
                    <div class="col-md-4 team-gd text-center">
                        <div class="team-img mb-4">
                            <img src="{{ asset('img/cxj/team2.jpg') }}" class="img-fluid" alt="user-image">
                        </div>
                        <div class="team-info">
        ...
        <div class="container pt-lg-3 pb-md-5">
            ...
            <div class="row news-grids pb-lg-5 mt-3 mt-lg-5">
                    ...
                    <div class="gal-info">
                        ...
                        <div class="property-info-list">
                            <div class="detail">
                                ...
                                <div class="location mt-2">
                                    <a href="about.html">
                                   <span class="fa fa-map-marker"></span> France / Paris
                                </a>
                                </div>
                                <ul class="facilities-list clearfix">
                                    <li>
                    ...
                    <div class="gal-info">
                        ...
                        <div class="property-info-list">
                            <div class="detail">
                                ...
                                <div class="location mt-2">
                                    <a href="about.html">
                                   <span class="fa fa-map-marker"></span> Melbourne / Sydney
                                </a>
                                </div>
                                <ul class="facilities-list clearfix">
                                    <li>
                ...
                <div class="col-lg-4 gal-img mt-lg-4">
                    <div class="gal-info">
                        <a href="#gal4"><img src="{{ asset('img/cxj/4.jpg') }}" alt="news image" class="img-fluid"></a>
                        <div class="property-info-list">
                           <div class="detail">
                                <h4 class="title">
                                    <a href="about.html">France</a>
                ...
                <div class="col-lg-4 gal-img mt-lg-4">
                    <div class="gal-info">
                        <a href="#gal5"><img src="{{ asset('img/cxj/5.jpg') }}" alt="news image" class="img-fluid"></a>
                        <div class="property-info-list">
                             <div class="detail">
                                <h4 class="title">
                                    <a href="about.html">Australia</a>
                ...
                <div class="col-lg-4 gal-img mt-lg-4">
                    <div class="gal-info">
                        <a href="#gal6"><img src="{{ asset('img/cxj/6.jpg') }}" alt="news image" class="img-fluid"></a>
                        <div class="property-info-list">
                           <div class="detail">
                                <h4 class="title">
                                    <a href="about.html">Germany</a>
    ...
    <div id="gal1" class="pop-overlay animate">
        <div class="popup">
            <img src="{{ asset('img/cxj/1.jpg') }}" alt="Popup Image" class="img-fluid" />
